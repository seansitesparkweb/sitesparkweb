    ...
    <section id="portfolio" className="py-24 px-4 sm:px-6" style={{ background: '#17130f' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <p className="text-sm font-semibold tracking-widest uppercase mb-3" style={{ color: '#f59e0b' }}>Website Previews</p>
          ...
          {projects.map((p, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ height: '220px', background: '#161008', borderBottom: '1px solid rgba(251,191,36,0.07)' }}
              >
                {/* Browser bar */}
                <div
